 ...
 <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- Dashboard -->
            <div class="bg-light text-success"><h1>Monthly Chart</h1></div>
            <div class="container">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                <canvas id="myAreaChart" height="450px"></canvas>
                </div>
            </div>
        </div>
     </div>     
          ...
          <!-- Content Row -->
          <div class="bg-light text-success"><h1>Members Table</h1></div>
          <table class="table">
...
<td><a href="?del=<?= $row['id']?>" onclick="return confirm('Are you sure to remove member');"><button name="btn_delete" class="btn btn-primary btn-user btn-block">Delete</button></a></td>
</tr>
<?php
}   }

if(isset($_GET["del"])){
  $sqll=$conn->query("DELETE FROM employee WHERE id =".$_GET["del"]);
  if($sqll==TRUE){
